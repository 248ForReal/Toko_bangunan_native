...
<div class="bg-white p-6 rounded-xl">
  <div class="mb-4 flex gap-4">
    <div class="flex items-center gap-2">
      ...
      <a id="pdf-link" href="?page=laporan-barang-keluar&act=add&start_date=${startDate}&end_date=${endDate}" class="py-2 px-4 inline-flex items-center gap-x-2 text-xs font-semibold rounded-lg border border-transparent bg-green-700 text-white hover:bg-green-800 transition-all">

...
function saveTransactionMasuk($totalBelanja, $kembalian, $items)
{
    ...
    return insertTransactionMasuk('transaksi_barang', $data);
}
...
$totalBelanja = array_reduce($cartItems, function ($carry, $item) {
    return $carry + ($item['harga_modal'] * $item['quantity']);
}, 0);
?>
                ...
                <div>
                  ...
                  <dl class="mt-0.5 space-y-px text-[10px] text-gray-600">
                    ...
                    <div>
                      ...
                      <dd class="inline"><?= $item['harga_modal'] ?></dd>
                    </div>
                  </dl>
                </div>
                ...
                <div class="flex flex-1 items-center justify-end gap-2">
                  <div class="py-2 px-3 inline-block bg-white border border-gray-200 rounded-lg">
                    <div class="flex items-center gap-x-1.5">
                      <button type="submit" name="update_quantity" value="decrease" <?= ($item['quantity'] <= 1) ? 'disabled' : ''; ?> class="w-6 h-6 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-md border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none">
          ...
          <tr class="odd:bg-gray-50">
            <form action="" method="POST">
              ...
              <td class="whitespace-nowrap px-4 py-2 text-gray-700 text-end">
                <input type="hidden" name="harga_modal" value="<?= $row['harga_modal'] ?>">
                <?= $row['harga_modal'] ?>
              </td>
              <td class="whitespace-nowrap px-4 py-2 text-gray-700">
